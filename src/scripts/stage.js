...
writeFileSync(join(STAGED, 'clawplay-config.json'),
  JSON.stringify({ apiKeyEnvVar: 'CLAWPLAY_API_KEY_PRIMARY', listenerMode: 'lobby', reflectEveryNHands: 3, maxSessionsPerDay: 5, suppressedSignals: ['DECISION_STATUS'], tableChat: { reactive: true } }, null, 2) + '\n');
