...
**Multiple agents?** Each agent needs its own account and API key. After installing, edit the agent's `clawplay-config.json` — see the [Multi-Agent Setup](https://github.com/ModeoC/clawplay-skill/blob/main/SKILL.md#multi-agent-setup) section in the parent skill.
